...
class dummy_window : public apis::windowing::iwindow_manager {
    bool initialize() noexcept override {return true;}
    std::shared_ptr<apis::windowing::iconsole_window> create_console_window() noexcept override {return {};}
    std::shared_ptr<apis::windowing::iapplication_window> create_application_window() noexcept override {return {};}
    std::shared_ptr<apis::windowing::iapplication_window> get_main_application_window() const noexcept override {return {};}
    bool update() noexcept override {return true;}
    bool should_quit() const noexcept override {return true;}
};

std::shared_ptr<apis::windowing::iwindow_manager> create_window_manager() {
